...
class Map:
    ...
    def create_wms_map(self, selected_display = True, selected_zoom = 13, popup_data = 0, selected_color = "green"):
        ...
        popup = popup_data,
        icon=folium.Icon(icon="glyphicon-home", color=selected_color),
        ).add_to(m)
        #--
        wms_url_list = [
